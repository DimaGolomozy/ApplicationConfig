 ...
 */
public class KVCacheApplicationConfigTest extends BaseApplicationConfigTest
{
    @BeforeClass
    public void before() throws Throwable
    {
        ...
        try {
            this.applicationConfig = new KVCacheApplicationConfig("dg/applicationConfigTest", 590,
